...
if not entries:
    ...
    if outside_count > 0:
        ...
        print()
        print("📋 Next steps:")
        print("   1. START PostgreSQL: Check if PostgreSQL service is running")
        print("   2. Restart Django server: python manage.py runserver 0.0.0.0:8000")
        print("   3. Check notifications table: python check_notifications.py")
        print("   4. Test by submitting material outside 4-7 PM window")
        print("   5. Check Flutter console for notification logs")
