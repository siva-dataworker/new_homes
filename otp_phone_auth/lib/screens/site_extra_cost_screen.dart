...
class SiteExtraCostScreen extends StatefulWidget {
  final Map<String, dynamic> site;

  const SiteExtraCostScreen({
    super.key,
    required this.site,
  });

  @override
  State<SiteExtraCostScreen> createState() => _SiteExtraCostScreenState();
}

class _SiteExtraCostScreenState extends State<SiteExtraCostScreen> {
